...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.max_pixel_intensity_label = QtWidgets.QLabel(self.centralwidget)
        self.max_pixel_intensity_label.setObjectName("max_pixel_intensity_label")
        self.verticalLayout_14.addWidget(self.max_pixel_intensity_label)
        self.max_pixel_intensity = QtWidgets.QSlider(self.centralwidget)
        self.max_pixel_intensity.setMaximum(9)
        self.max_pixel_intensity.setDisabled(True)
        self.max_pixel_intensity.setStyleSheet('selection-background-color: grey')
        self.max_pixel_intensity.setProperty("value", 9)
        self.max_pixel_intensity.setOrientation(QtCore.Qt.Vertical)
        self.max_pixel_intensity.setTickPosition(QtWidgets.QSlider.TicksBothSides)
        self.max_pixel_intensity.setObjectName("max_pixel_intensity")
        self.verticalLayout_14.addWidget(self.max_pixel_intensity)
        self.max_pixel_intensity_lab = QtWidgets.QLabel(self.centralwidget)
        self.max_pixel_intensity_lab.setAlignment(QtCore.Qt.AlignCenter)
        self.max_pixel_intensity_lab.setObjectName("max_pixel_intensity_lab")
        self.verticalLayout_14.addWidget(self.max_pixel_intensity_lab)
        self.gridLayout.addLayout(self.verticalLayout_14, 1, 2, 1, 1)
        self.verticalLayout_15 = QtWidgets.QVBoxLayout()
        self.verticalLayout_15.setObjectName("verticalLayout_15")
        self.min_pixel_intensity_label = QtWidgets.QLabel(self.centralwidget)
        self.min_pixel_intensity_label.setObjectName("min_pixel_intensity_label")
        self.verticalLayout_15.addWidget(self.min_pixel_intensity_label)
        self.min_pixel_intensity = QtWidgets.QSlider(self.centralwidget)
        self.min_pixel_intensity.setMaximum(9)
        self.min_pixel_intensity.setDisabled(True)
        self.min_pixel_intensity.setStyleSheet('selection-background-color: grey')
        self.min_pixel_intensity.setOrientation(QtCore.Qt.Vertical)
        self.min_pixel_intensity.setTickPosition(QtWidgets.QSlider.TicksBothSides)
        self.min_pixel_intensity.setObjectName("min_pixel_intensity")
        self.verticalLayout_15.addWidget(self.min_pixel_intensity)
        self.min_pixel_intensity_lab = QtWidgets.QLabel(self.centralwidget)
        self.min_pixel_intensity_lab.setAlignment(QtCore.Qt.AlignCenter)
        self.min_pixel_intensity_lab.setObjectName("min_pixel_intensity_lab")
        self.verticalLayout_15.addWidget(self.min_pixel_intensity_lab)
        ...
        self.save_session_data = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.save_session_data.setFont(font)
        self.save_session_data.setObjectName("save_session_data")
        self.verticalLayout_13.addWidget(self.save_session_data)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.max_pixel_intensity_label.setText(_translate("MainWindow", "MAX"))
        self.max_pixel_intensity_lab.setText(_translate("MainWindow", ""))
        self.min_pixel_intensity_label.setText(_translate("MainWindow", "MIN"))
        self.min_pixel_intensity_lab.setText(_translate("MainWindow", ""))
        ...
        self.save_session_data.setText(_translate("MainWindow", "Save PDF and Wav"))
